...
from scipy.sparse import hstack  # gerekli
...
WINSOR_LO = 0.00973                   # alt yüzde
WINSOR_HI = 0.9785                    # üst yüzde
...
# İkili setlerin P50'si (tam iki ICD'li satırlardan)
...
# Demografi (YG+Bölüm) bazlı P90 cap referansı
DEMO_P90_MAP = (
...
for _, row in LKP_PAIR.iterrows():
    ...
    pair_to_gamma_samples[(j,i)] = pair_to_gamma_samples[(j,i)] + [delta]
...
def model_contrib(target_key:str, anchor_key:str):
    ...
    beta_sum   = beta_plus - REMOVAL_PENALTY * beta_minus
    ...
    gamma_sum   = gamma_plus - REMOVAL_PENALTY * gamma_minus
...
_true_cands = ["yatis_gun_sayisi", "yatis_gun_sayisi_"]
TRUE_LOS_COL = None
